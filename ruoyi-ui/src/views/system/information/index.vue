<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="informationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="新闻摘要" align="center" prop="digest" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="新闻摘要" prop="digest">
          <el-input v-model="form.digest" placeholder="请输入新闻摘要" />
        </el-form-item>
        <el-form-item label="选择租户" >
          <el-select v-model="form.tenement" placeholder="请选择" value-key="form.tenement">
            <el-option v-for="item in tenementList" :key="item.value" :label="item.name"
...
import {listTenement} from "@/api/system/tenement"
import tenement from "@/views/system/tenement/index.vue";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除行业动态（资讯）管理编号为"' + ids + '"的数据项？').then(function() {
